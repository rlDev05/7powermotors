        ...
        <div className="mx-auto max-w-7xl">
          <section className="racing-card racing-slashed mb-10">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.72fr]">
              ...
              <div className="grid min-h-[320px] grid-cols-2 gap-3 bg-secondary/50 p-8">
                {careProducts.slice(0, 4).map((product) => (
                  <div key={product.id} className="flex items-center justify-center border border-border bg-white p-4">
                    <img
                      src={product.image}
                      alt={product.name}
